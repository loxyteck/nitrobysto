...
/*    ***** ATTRIBUTION NOTICE *****
 *
 * STO Nitro is a free BetterDiscord plugin that bypasses and unlocks Nitro-locked features in the Discord client.
 *
 * Copyright (c) 2026 Shouto and contributors
 *
...
//#region Module Hell
const {Webpack,Patcher,Net,React,UI,Logger,Data,Components,DOM,Plugins,ContextMenu} = new BdApi("STONitro");
...
const config = {
    info: {
        ...
        "authors": [{
            "name": "shouto",
            "discord_id": "1136773028840218755",
            "github_username": "Shouto"
        }],
        "version": "6.7.4",
        "description": "Unlock all screensharing modes, use cross-server & GIF emotes, and more!",
        "github": "https://github.com/loxyteck"
...
module.exports = class S {
    ...
    honorBadge(){
        ...
        DOM.addStyle("StoNitroBadges", `
            a[aria-label="Nitro"] img {
                content: url("https://cdn3.emoji.gg/emojis/67822-opal-nitro-tier.png") !important;
            }
            
            div [aria-label="Nitro"] > a > img {
                content: url("https://cdn3.emoji.gg/emojis/67822-opal-nitro-tier.png") !important;
            }

            a[aria-label="Creator"] img {
                content: url("https://discordresources.com/img/discordstaff.svg") !important;
            }
            a[aria-label="Partner"] img  {
                content: url("https://discordresources.com/img/discordpartner.svg") !important;
             }   
            div [aria-label="Creator"] > a > img {
                content: url("https://discordresources.com/img/discordstaff.svg") !important;
            }
            
            div [aria-label="Partner"] > a > img {
                content: url("https://discordresources.com/img/discordpartner.svg") !important;
            }
        `);
    ...
    async profileFX(secondsightifyEncodeOnly){
        ...
        Patcher.after(this.profileEffectSectionRenderer, ProfileEffectSectionFnName, (_, [args], ret) => {
            ...
            ret.props.children.props.children.push(
                ...
                React.createElement("button", {
                    children: "Change Effect [STO Nitro]",
                    className: `yabd-generic-button`,
                    ...
                    onClick: () => {
                        UI.showConfirmationModal("Change Profile Effect (STO Nitro)", React.createElement(EffectsModal), {cancelText:""});
                    }
        ...
        Patcher.after(this.decorationCustomizationSectionMod, fnName, (_, [args], ret) => {
            ...
            if(ret?.props?.children){
                ret.props.children.push(
                    React.createElement("button", {
                        id: "decorationButton",
                        children: "Change Decoration [STO Nitro]",
                        style: {
                            width: "100px",
                            height: "50px",
                            color: "white",
                        ...
                        className: "yabd-generic-button",
                        onClick: () => {
                            UI.showConfirmationModal("Change Avatar Decoration (STO Nitro)", React.createElement(DecorModal), {cancelText:""});
                        }
                    })
                );
            }
